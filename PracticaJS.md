...
- Una forma de estruturarlo: Seria crear un fichero por objeto, mano.js, el otromodelo.js y luego un fichero main.js donde creas las cartas, creas las manos, lo demás está en los otros ficheros.